...
activities = {
    ...
    "Soccer Team": {
        "description": "Practice team soccer skills and compete in local matches",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 28,
        "participants": ["noah@mergington.edu", "lucas@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Swim laps, learn new strokes, and prepare for regional meets",
    ...
    "Drama Club": {
        "description": "Act in plays, improvise scenes, and learn stagecraft",
